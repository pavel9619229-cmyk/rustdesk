...
A SECOND typo was found and fixed on 2026-08-13 (later in session): the "corrected"
key was still missing a `G` after `...TIC9...` (was `9ceMofgvYTVTIC95mhjgm...`,
should be `9ceMofgvYTVTIC9G5mhjgm...`). Verified against the live server's
`id_ed25519.pub` file on the VPS (`/opt/masha-rustdesk/id_ed25519.pub`) via
`cat` in the noVNC console. Fixed in commit 922372ba7.
